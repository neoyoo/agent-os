...
deployment:
  ...
  state_plane:
    ...
    live_backend_verification:
      ...
      expected_backend_kinds: LIVE_BACKEND_VERIFICATION_EXPECTED_BACKEND_KINDS
      ...
      block_policy: block_production_readiness on missing or failed backend evidence, invalid evidence, or backend kind mismatch
