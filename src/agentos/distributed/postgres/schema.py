...
SCHEMA_STATEMENTS = (
    ...
    CREATE UNIQUE INDEX IF NOT EXISTS
        agentos_distributed_one_active_run
    ...
    """
    CREATE UNIQUE INDEX IF NOT EXISTS
        agentos_distributed_one_pending_input
...
async def initialize_postgres_schema(connection: AsyncConnection) -> None:
    ...
    if not rows:
        ...
        raise ValueError("distributed schema version is unsupported")


__all__ = ["SCHEMA_VERSION", "SCHEMA_STATEMENTS", "initialize_postgres_schema"]
